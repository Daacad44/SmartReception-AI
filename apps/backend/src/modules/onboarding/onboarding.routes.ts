...
router.patch('/description', (req, res, next) => onboardingController.description(req, res, next));
router.patch('/services', (req, res, next) => onboardingController.services(req, res, next));
router.patch('/working-hours', (req, res, next) => onboardingController.workingHours(req, res, next));
router.patch('/languages', (req, res, next) => onboardingController.languages(req, res, next));
