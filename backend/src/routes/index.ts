...
import appointmentSchedulingRoutes from '../modules/appointment-scheduling/appointment-scheduling.routes';
...
licensed.use('/appointment-scheduling', appointmentSchedulingRoutes);
