...
const AdminAITrainingDetail = lazyWithRetry(() =>
  import('@/pages/AdminAITrainingDetail').then((m) => ({
              ...
              <Routes>
                ...
                >
                  ...
                  <Route
                    ...
                    element={<Navigate to="/admin/enterprise-ai-intelligence" replace />}
                  />
                  <Route
